        ...
        <div class="col-lg-6">
          <div class="about-content">
            <div class="section-title">
              ...
              <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tincidunt ante tellus, sit amet rhoncus massa aliquam sit amet. Cras porttitor mauris quis mattis ornare. In efficitur at sem quis pretium. Aenean sit amet neque ut dolor lacinia rutrum. In vulputate pellentesque turpis et porta. </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row pt-45">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="choose-card">
            ...
            <p> This is the place where I will get a free wifi zone at a reasonable price and this will help you to make a colorful life </p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6  ">
          <div class="choose-card">
      ...
      <div class="row pt-45">
        <div class="col-lg-4 col-md-6">
          <div class="team-card">
            ...
            <div class="content">
              <h3>
                <a href="team.html">Tom Shumate</a>
              </h3>
              <span>Manager</span>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="team-card">
            ...
            <div class="content">
              <h3>
                <a href="team.html">Carrie Horton</a>
              </h3>
        ...
        <div class="col-lg-4 col-md-6  ">
          <div class="team-card">
            ...
            <div class="content">
              <h3>
                <a href="team.html">Brian Orlando</a>
              </h3>
    ...
    <div class="container">
      ...
      <div class="testimonials-slider-three owl-carousel owl-theme pt-45">
        <div class="testimonials-item">
          ...
          <p> You can easily make a good and easily the best service from this agency. This is one of the best and crucial service for us. </p>
          <ul>
            <li>
