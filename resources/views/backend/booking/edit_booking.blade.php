              ...
              <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Rp.{{ number_format($editData->actual_price *  $editData->number_of_rooms, 2) }}</td>
                ...
                <div class="col-md-6" style="float: right">
                    ...
                    <table class="table test_table" style="float: right" border="none">
                        <tr>
                            <td>Subtotal</td>
                            <td>Rp.{{ number_format($editData->subtotal, 2) }}</td>
                        </tr>
                        <tr>
                            <td>Discount</td>
                            <td>Rp.{{ number_format($editData->discount, 2) }}</td>
                        </tr>
                        <tr>
                            <td>Grand Total</td>
